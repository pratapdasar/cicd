...
variable "region" {
  description = "AWS Region in which you want to deploy this pipeline into"
  type = string
}
...
variable "validation_stage_input" {
  description = "Tags to be attached to the CodePipeline"
  type        = list(map(any))
}

variable "deploy_stage_input" {
  description = "Tags to be attached to the CodePipeline"
  type        = list(map(any))
}
...
//  type = string
//  description = "SNS Topic ARN to notify plan updates before apply action"
//}